# Runtime- und Client-Modell

Diese Seite beschreibt das Szenario „Runtime- und Client-Modell“ und verwendet die gemeinsame Runtime/Client-Struktur der Dokumentation.
